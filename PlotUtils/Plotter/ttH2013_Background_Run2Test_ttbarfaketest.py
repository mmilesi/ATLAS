...
from Plotter.BackgroundTools_ttH_ttbarfaketest import loadSamples, drawText, Category, Background, Process, VariableDB, Variable, Cut, Systematics, Category
...
class TTHBackgrounds2013(Background):
    backgrounds = [ 'TTBarW', 'TTBarZ', 'Top', 'TopCF', 'Diboson', 'DibosonCF', 'HtoZZ', 'Zjets', 'Wjets', 'Prompt', 'ChargeFlip', 'FakesFF', 'FakesMM']#this is the list of backgrounds that will be calculated
    signals = ['TTBarH']
    observed = ['Observed']
    #luminosity = 13.0258
    luminosity = 5.4
    channel= 'TwoLepSS' # 'TwoLepCR', 'ThreeLep', 'FourLep'
    #eventweight = 'evtsel_weight'
    eventweight = 1.
    ...
    class Observed(Process):
        ...
        def __call__(self, treename='physics', category=None, options={}):
            ...
            if self.parent.channel=='TwoLepSS':
                ...
                isocut='3LepTT'
            #print 'Observed weight ', weight, ' isocut ', isocut
            if isocut!='':
    ...
    class FakesFF(Process):
        ...
        def __call__(self, treename='physics', category=None, options={}):
            ...
            print 'FF weight ', weight, ' notisocut ', notisocut, ' notisocut2 ', notisocut2
    ...
    class FakesMM(Process):
        ...
        def __call__(self, treename='physics', category=None, options={}):
            ...
            #print 'MM weight ', weight, ' isocut ', isocut , ' notisocut ', notisocut, ' notisocut2 ', notisocut2
