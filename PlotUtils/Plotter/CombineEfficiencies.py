...
def copyMuon():
  ...
  if ( args.triggerMatching == "UNBIASED" ):
    path_r_mu = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000/"
  elif ( args.triggerMatching == "YES_TM" ):
    path_r_mu = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000_TRIGMATCH_EFF/"
  elif ( args.triggerMatching == "NOT_TM" ):
    path_r_mu = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000_NOT_TRIGMATCH_EFF/"
  ...
  if ( args.triggerMatching == "UNBIASED" ) :
    path_f_mu = "./PLOTS_25ns_v26/MMClosure_v26_LikelihoodFit/OutputPlots_MMClosureRates_LHFit_DLT_25ns_v26_LeptonCutBased_410000/"
  elif ( args.triggerMatching == "YES_TM" ):
    path_f_mu = "./PLOTS_25ns_v26/MMClosure_v26_LikelihoodFit/OutputPlots_MMClosureRates_LHFit_DLT_25ns_v26_LeptonCutBased_410000_TRIGMATCH_EFF/"
  elif ( args.triggerMatching == "NOT_TM" ):
    path_f_mu = "./PLOTS_25ns_v26/MMClosure_v26_LikelihoodFit/OutputPlots_MMClosureRates_LHFit_DLT_25ns_v26_LeptonCutBased_410000_NOT_TRIGMATCH_EFF/"
...
def copyElectron():
  ...
  if ( args.triggerMatching == "UNBIASED" ):
    path_r_el = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000/"
  elif ( args.triggerMatching == "YES_TM" ):
    path_r_el = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000_TRIGMATCH_EFF/"
  elif ( args.triggerMatching == "NOT_TM" ):
    path_r_el = "./PLOTS_25ns_v26/MMClosure_v26_SUSYTP/OutputPlots_MMClosureRates_25ns_v26_LeptonCutBased_EtaBarrel_410000_NOT_TRIGMATCH_EFF/"
