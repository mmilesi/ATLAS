...
class TTHBackgrounds2015(Background):
    ...
    class MadGraphWenujets(Process):
    ...
    class MadGraphWmunujets(Process):
    ...
    class MadGraphWtaunujets(Process):
    ...
    class SherpaWtaunujets(Process):
        latexname = 'W#rightarrow#tau#nu+jets'
        colour = kYellow
