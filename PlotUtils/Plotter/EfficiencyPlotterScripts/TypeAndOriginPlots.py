...
def plotTypeVSOrigin( prodID ):
    ...
    extension = ("","_NORM")[ "normFactor" in p0_props ]
    ...
    savePath = os.path.abspath(os.curdir) + "/" + "PLOTS_" + prodID + "/MMClosure_v24_SUSYTP/OutputPlots_MMRates_SUSYTagProbe_SLT_DataMC_FAKE_CR_" + prodID + "_LOWNJ/TypeOriginPlots_" + prodID + "/"
    saveName = canvasID
