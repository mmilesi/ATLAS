...
def plotFakeEfficiency_El_NBJetsOnly():
    ...
    p0 = Plot("RESCALED_2L_ee_Fake_El_NBJets_VS_Pt_Efficiency_observed_sub_projNBJets_1",eff_filepath, p0_props)
    p0.addSystematics(syslist=["ND_VV","ND_TTV","ND_OtherPromptSS","N_QMisID","D_QMisID","ND_ALPHA"])
    ...
    multiP.makeMultiPlot( outdir, "FakeRate_El_NBJetsOnly" )
