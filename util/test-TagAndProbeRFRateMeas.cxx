...
int main ( int argc, char **argv ) {
    ...
    BasicEventSelection* baseEventSel 		  = new BasicEventSelection("baseEventSel",localDataDir+"Event/"+"baseEvent_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    JetCalibrator* jetCalib           		  = new JetCalibrator("jetCalib_AntiKt4TopoLC",localDataDir+"Jets/"+"jetCalib_AntiKt4TopoLCCalib.config");
    JetSelector* jetSelect_selected   		  = new JetSelector("jetSelect_selected",localDataDir+"Jets/"+"jetSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    ...
    MuonSelector* muonSelect_preselected 	  = new MuonSelector("muonSelect_preselected",localDataDir+"Muons/"+"muonPreSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    MuonSelector* muonSelect_selected    	  = new MuonSelector("muonSelect_selected",localDataDir+"Muons/"+"muonSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    ...
    ElectronSelector* electronSelect_preselected  = new ElectronSelector("electronSelect_preselected",localDataDir+"Electrons/"+"electronPreSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    ElectronSelector* electronSelect_selected     = new ElectronSelector("electronSelect_selected",localDataDir+"Electrons/"+"electronSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    OverlapRemover*  overlapRemover               = new OverlapRemover("overlapRemover",localDataDir+"OverlapRemoval/"+"overlapRemoval_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    HTopMultilepEventSelector *eventSelect        = new HTopMultilepEventSelector("eventSelect_skim",localDataDir+"Event/"+"eventSelect_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    ...
    TagAndProbeRFRateMeasurement* analysis        = new TagAndProbeRFRateMeasurement("TagAndProbeRFRateMeas",localDataDir+"Analysis/"+"analysis_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    // Add tree algo
    TagAndProbeTreeAlgo* out_tree                 = new TagAndProbeTreeAlgo("physics", localDataDir+"Tree/"+"tree_TagAndProbeRFRateMeas"+"_"+inDSType+".config");
    // dump plots - jets
    ...
    if ( lxbatch ) {
      ...
      driver.shellInit = "export ATLAS_LOCAL_ROOT_BASE=/cvmfs/atlas.cern.ch/repo/ATLASLocalRootBase && source ${ATLAS_LOCAL_ROOT_BASE}/user/atlasLocalSetup.sh && eval rcSetup Base,2.1.27"; // or whatever version of the Analysis Release you are using    
