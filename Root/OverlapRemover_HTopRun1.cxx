...
OverlapRemover_HTopRun1 :: OverlapRemover_HTopRun1 () :
  m_usePhotons(false),
  m_useTaus(false),
  ...
  m_ph_cutflowHist_1(nullptr)
{
  ...
  Info("OverlapRemover_HTopRun1()", "Calling constructor");
...
EL::StatusCode  OverlapRemover_HTopRun1 :: configure ()
{

  if ( !getConfig().empty() ) {

    Info("configure()", "Configuing OverlapRemover_HTopRun1 Interface. User configuration read from : %s ", getConfig().c_str());
    ...
    config->Print();
    Info("configure()", "OverlapRemover_HTopRun1 Interface succesfully configured! ");
...
EL::StatusCode OverlapRemover_HTopRun1 :: setupJob (EL::Job& job)
{
  ...
  job.useXAOD ();
  xAOD::Init( "OverlapRemover_HTopRun1" ).ignore(); // call before opening first file
...
EL::StatusCode OverlapRemover_HTopRun1 :: histInitialize ()
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: fileExecute ()
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: changeInput (bool /*firstFile*/)
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: initialize ()
{
 ...
 if ( m_useCutFlow ) {
  ...
  //
  m_overlapRemovalTool = new OverlapRemovalTool_HTopRun1( "OverlapRemovalTool_HTopRun1" );
  ...
  RETURN_CHECK( "OverlapRemover_HTopRun1::initialize()", m_overlapRemovalTool->setProperty("InputLabel",  selected_label), "");
  RETURN_CHECK( "OverlapRemover_HTopRun1::initialize()", m_overlapRemovalTool->setProperty("OverlapLabel", "overlaps"), "Failed to set property OverlapLabel"); // tool will decorate objects with 'overlaps' boolean if they overlap 
  RETURN_CHECK( "OverlapRemover_HTopRun1::initialize()", m_overlapRemovalTool->initialize(), "Failed to properly initialize the OverlapRemovalTool.");
...
EL::StatusCode OverlapRemover_HTopRun1 :: execute ()
{
  ...
  if ( !m_inputAlgoElectrons.empty() ) {
    ...
    RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(systNames_el, m_inputAlgoElectrons, 0, m_store, m_verbose) ,"");
  ...
  if ( !m_inputAlgoMuons.empty() ) {
    ...
    RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(systNames_mu, m_inputAlgoMuons, 0, m_store, m_verbose) ,"");
  ...
  if ( !m_inputAlgoJets.empty() ) {
    ...
    RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(systNames_jet, m_inputAlgoJets, 0, m_store, m_verbose) ,"");
  ...
  if ( !m_inputAlgoPhotons.empty() ) {
    ...
    RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(systNames_photon, m_inputAlgoPhotons, 0, m_store, m_verbose) ,"");
...
EL::StatusCode OverlapRemover_HTopRun1 :: postExecute ()
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: finalize ()
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: histFinalize ()
{
...
EL::StatusCode OverlapRemover_HTopRun1 :: fillObjectCutflow (const char* type, const xAOD::IParticleContainer* objCont, const std::string& selectFlag, const std::string& overlapFlag)
{
  ...
  for ( auto obj_itr : *(objCont) ) {
	...
	case xAOD::Type::Photon:
	  ...
	  break;
	default:
	  Error("OverlapRemover_HTopRun1::fillObjectCutflow()","Unsupported object");
	  return EL::StatusCode::FAILURE;
	  break;
	}
    }
...
EL::StatusCode OverlapRemover_HTopRun1 :: executeOR(  const xAOD::ElectronContainer* inElectrons, const xAOD::MuonContainer* inMuons, const xAOD::JetContainer* inJets,
					     ...
					     SystType syst_type, std::vector<std::string>* sysVec)
{
  ...
  switch ( static_cast<int>(syst_type) )
  {
    ...
    case NOMINAL:  // this is the nominal case
    {
      ...
      if ( m_store->contains<ConstDataVector<xAOD::ElectronContainer> >(m_inContainerName_Electrons) ) {
        RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inElectrons, m_inContainerName_Electrons, m_event, m_store, m_verbose) ,"");
      } else {
      ...
      if ( m_store->contains<ConstDataVector<xAOD::MuonContainer> >(m_inContainerName_Muons) ) {
        RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inMuons, m_inContainerName_Muons, m_event, m_store, m_verbose) ,"");
      } else {
        nomContainerNotFound = true;
      ...
      if ( m_store->contains<ConstDataVector<xAOD::JetContainer> >(m_inContainerName_Jets) ) {
        RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inJets, m_inContainerName_Jets, m_event, m_store, m_verbose) ,"");
      } else {
        nomContainerNotFound = true;
      ...
      if ( m_usePhotons ) {      
	   ...
	   RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inPhotons, m_inContainerName_Photons, m_event, m_store, m_verbose) ,"");
         } else {
           nomContainerNotFound = true;
      ...
      if ( m_useTaus ) {      
	   ...
	   RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inTaus, m_inContainerName_Taus, m_event, m_store, m_verbose) ,"");
         } else {
           nomContainerNotFound = true;
      ...
      // do the actual OR
      //
      RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_overlapRemovalTool->removeOverlaps(inElectrons, inMuons, inJets, inTaus, inPhotons), "");
      ...
      //
      RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inElectrons, selectedElectrons, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
      RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inMuons, selectedMuons, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
      RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inJets, selectedJets, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
      ...
      //
      if ( m_createSelectedContainers ) {
        RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedElectrons,   m_outContainerName_Electrons ), "Failed to store const data container");
        RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedMuons,	 m_outContainerName_Muons ), "Failed to store const data container");
        RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedJets,	 m_outContainerName_Jets ), "Failed to store const data container");
        if ( m_usePhotons ){ RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedPhotons, m_outContainerName_Photons ), "Failed to store const data container"); }
        if ( m_useTaus )   { RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedTaus, m_outContainerName_Taus ), "Failed to store const data container"); }
      }
 ...
 case ELSYST : // electron syst
	...
	std::string el_syst_cont_name = m_inContainerName_Electrons + systName;
        if ( m_store->contains<ConstDataVector<xAOD::ElectronContainer> >(el_syst_cont_name) ) {
          RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inElectrons, el_syst_cont_name, m_event, m_store, m_verbose) ,"");
        } else {
	...
	//
        if ( m_createSelectedContainers ) {
          ...
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedElectrons, m_outContainerName_Electrons + systName ), "Failed to store const data container");
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedMuons,     m_outContainerName_Muons + systName ), "Failed to store const data container");
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedJets,      m_outContainerName_Jets + systName ), "Failed to store const data container");
          if ( m_usePhotons ){ RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedPhotons, m_outContainerName_Photons + systName ), "Failed to store const data container"); }
          if ( m_useTaus )   { RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedTaus, m_outContainerName_Taus + systName ), "Failed to store const data container"); }
        }
 ...
 case MUSYST: // muon syst
	...
	std::string mu_syst_cont_name = m_inContainerName_Muons + systName;
        if ( m_store->contains<ConstDataVector<xAOD::MuonContainer> >(mu_syst_cont_name) ) {
          RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inMuons, mu_syst_cont_name, m_event, m_store, m_verbose) ,"");
        } else {
	...
	return EL::StatusCode::FAILURE;
	 ...
	 std::string photon_syst_cont_name = m_inContainerName_Photons + systName;
         if ( m_store->contains<ConstDataVector<xAOD::PhotonContainer> >(photon_syst_cont_name) ) {
           RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inPhotons, photon_syst_cont_name, m_event, m_store, m_verbose) ,"");
         } else {
 ...
 case PHSYST : // photon systematics
    {
      ...
      RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inMuons, m_inContainerName_Muons, m_event, m_store, m_verbose) ,"");
      RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inJets, m_inContainerName_Jets, m_event, m_store, m_verbose) ,"");
      if ( m_useTaus )     RETURN_CHECK("OverlapRemover_HTopRun1::execute()", HelperFunctions::retrieve(inTaus, m_inContainerName_Taus, m_event, m_store, m_verbose) ,"");
	...
	//
        ...
        RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inMuons, selectedMuons, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
        RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inJets, selectedJets, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
	RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inPhotons, selectedPhotons, ORdecor.c_str(), ToolName::OVERLAPREMOVER), "");
        if ( m_useTaus )    { RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", HelperFunctions::makeSubsetCont(inTaus, selectedTaus, ORdecor.c_str(), ToolName::OVERLAPREMOVER), ""); }
	...
	//
	  ...
	  //
          ...
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedMuons,     m_outContainerName_Muons + systName ), "Failed to store const data container");
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedJets,      m_outContainerName_Jets + systName ), "Failed to store const data container");
          RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedPhotons,   m_outContainerName_Photons + systName ), "Failed to store const data container");
          if ( m_useTaus )   { RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( selectedTaus, m_outContainerName_Taus + systName ), "Failed to store const data container"); }
        }
      ...
      //
      RETURN_CHECK( "OverlapRemover_HTopRun1::execute()", m_store->record( vecOutContainerNames_jet, m_outputAlgoJets ), "Failed to record vector of output container names.");
 ...
 default :
    {
      Error("OverlapRemover_HTopRun1::execute()","Unknown systematics type. Aborting");
      return EL::StatusCode::FAILURE;
    }
  } // end of switch
