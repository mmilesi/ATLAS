...
"410189",
	...
	"sub_dir"     :  "/coepp/cephfs/mel/mmilesi/ttH/PBS/" + prod_ID + "_PBS_DLT_TrigMatching_Retry_SLTDLT_TP",  # The path to the submission node (NB: must NOT be under /home : PBS cannot read/write into it!!)
