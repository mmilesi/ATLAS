...
BasicEventSelectionDict = { "m_name"		      : "baseEventSel",
		            "m_debug"		      : False,
                            "m_applyGRLCut"	      : True,
			    "m_GRLxml"  	      : "$ROOTCOREBIN/data/HTopMultilepAnalysis/External/data15_13TeV.periodAllYear_DetStatus-v71-pro19-06_DQDefects-00-01-02_PHYS_StandardGRL_All_Good_25ns.xml",
...
ElectronEfficiencyCorrectorDict = { "m_name"                  : "electronEfficiencyCorrector",
				    ...
				    "m_inputAlgoSystNames"    : "ElectronSelector_Syst",
         	        	    ...
         	        	    "m_corrFileNameReco"      : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.offline.RecoTrk.2015.13TeV.rel20p0.25ns.v01.root",
         	        	    "m_corrFileNamePID"       : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.offline.LooseLH.2015.13TeV.rel20p0.25ns.v01.root",
         	        	    "m_corrFileNameTrig"      : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.AnyElectronTrigger.MediumLH.2015.13TeV.rel20p0.25ns.v01.root",
                                  }

ElectronEfficiencyCorrectorLHTightDict = { "m_name"                  : "electronEfficiencyCorrector_LHTight",
		                    	   "m_debug"		     : False,
                        	    	   "m_inContainerName"       : "Electrons_OR",
				    	   "m_inputAlgoSystNames"    : "ElectronSelector_Syst",
         	        	    	   "m_systNameReco"	     : "",
         	        	    	   ...
         	        	    	   "m_outputSystNamesTrig"   : "ElectronEfficiencyCorrector_TrigSyst",
         	        	    	   "m_corrFileNameReco"      : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.offline.RecoTrk.2015.13TeV.rel20p0.25ns.v01.root",
         	        	    	   "m_corrFileNamePID"       : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.offline.TightLH.2015.13TeV.rel20p0.25ns.v01.root",
         	        	    	   "m_corrFileNameTrig"      : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.AnyElectronTrigger.MediumLH.2015.13TeV.rel20p0.25ns.v01.root",
                                         }
