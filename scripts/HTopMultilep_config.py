...
BasicEventSelectionDict = { "m_name"		      : "baseEventSel",
			    ...
			    "m_lumiCalcFileNames"     : "$ROOTCOREBIN/data/HTopMultilepAnalysis/External/ilumicalc_histograms_None_276262-284484.root",
			    ...
			    #"m_PRWFileNames"	      : "$ROOTCOREBIN/data/HTopMultilepAnalysis/External/tthML.PURWTconfig.410009.mc15b.root",
...
HTopMultilepEventSelectorDict = { "m_name"                   : "eventSelect_skim",
                		  ...
                		  "m_inContainerName_tau"    : "Taus_OR",
                		  "m_outContainerName_lep"   : "Leptons_OR",
		                  "m_doMinObjCut"            : True,
		                  "m_doMaxObjCut"            : False,
   				  "m_n_leptons_min"          : 2,
   				  "m_n_leptons_with_tau_min" : 2,
   				  "m_n_taus_min"             : 2,
