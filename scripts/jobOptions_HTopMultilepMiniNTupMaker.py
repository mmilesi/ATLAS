...
trigbits_branches    = [ # SLT muon 2015
			...
			"HLT_mu24_ivarmedium",
                        ...
                        "HLT_mu18_mu8noL1",
                        # DLT - mm - 2016
                        #"HLT_2mu10_nomucomb", --> missing in v15 ntup
			#"HLT_2mu14_nomucomb", --> missing in v15 ntup
                        "HLT_mu20_mu8noL1",
                        # DLT - OF - 2015
                        "HLT_e17_loose_mu14",
...
lep_branches         = ["lep_ID_0","lep_Index_0","lep_Pt_0","lep_E_0","lep_Eta_0","lep_Phi_0","lep_EtaBE2_0","lep_sigd0PV_0","lep_Z0SinTheta_0",
                        ...
                        "lep_isTrigMatch_0","lep_isPrompt_0","lep_isBrems_0","lep_isFakeLep_0","lep_isQMisID_0","lep_isConvPh_0","lep_isISR_FSR_Ph_0",
                        "lep_isTruthMatched_0","lep_truthType_0","lep_truthOrigin_0","lep_truthPdgId_0","lep_truthStatus_0",
                        "lep_truthParentType_0","lep_truthParentOrigin_0","lep_truthParentPdgId_0","lep_truthParentStatus_0",
                        "lep_truthPt_0","lep_truthEta_0","lep_truthPhi_0","lep_truthM_0","lep_truthE_0","lep_truthRapidity_0",
                        "lep_SFIDLoose_0","lep_SFIDTight_0","lep_SFTrigLoose_0","lep_SFTrigTight_0","lep_EffTrigLoose_0","lep_EffTrigTight_0","lep_SFIsoLoose_0","lep_SFIsoTight_0","lep_SFReco_0","lep_SFTTVA_0","lep_SFObjLoose_0","lep_SFObjTight_0",
                        ...
                        "lep_isTrigMatch_1","lep_isPrompt_1","lep_isBrems_1","lep_isFakeLep_1","lep_isQMisID_1","lep_isConvPh_1","lep_isISR_FSR_Ph_1",
                        "lep_isTruthMatched_1","lep_truthType_1","lep_truthOrigin_1","lep_truthPdgId_1","lep_truthStatus_1",
                        "lep_truthParentType_1","lep_truthParentOrigin_1","lep_truthParentPdgId_1","lep_truthParentStatus_1",
                        "lep_truthPt_1","lep_truthEta_1","lep_truthPhi_1","lep_truthM_1","lep_truthE_1","lep_truthRapidity_1",
                        "lep_SFIDLoose_1","lep_SFIDTight_1","lep_SFTrigLoose_1","lep_SFTrigTight_1","lep_EffTrigLoose_1","lep_EffTrigTight_1","lep_SFIsoLoose_1","lep_SFIsoTight_1","lep_SFReco_1","lep_SFTTVA_1","lep_SFObjLoose_1","lep_SFObjTight_1",
                        ...
                        "lep_isTrigMatch_2","lep_isPrompt_2","lep_isBrems_2","lep_isFakeLep_2","lep_isQMisID_2","lep_isConvPh_2","lep_isISR_FSR_Ph_2",
                        "lep_isTruthMatched_2","lep_truthType_2","lep_truthOrigin_2","lep_truthPdgId_2","lep_truthStatus_2",
                        "lep_truthParentType_2","lep_truthParentOrigin_2","lep_truthParentPdgId_2","lep_truthParentStatus_2",
                        "lep_truthPt_2","lep_truthEta_2","lep_truthPhi_2","lep_truthM_2","lep_truthE_2","lep_truthRapidity_2",
                        "lep_SFIDLoose_2","lep_SFIDTight_2","lep_SFTrigLoose_2","lep_SFTrigTight_2","lep_EffTrigLoose_2","lep_EffTrigTight_2","lep_SFIsoLoose_2","lep_SFIsoTight_2","lep_SFReco_2","lep_SFTTVA_2","lep_SFObjLoose_2","lep_SFObjTight_2"]
