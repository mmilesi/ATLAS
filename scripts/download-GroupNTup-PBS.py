...
"410189",
	...
	"subdir"       :  "/coepp/cephfs/mel/mmilesi/ttH/PBS/Download_GroupNTup/" + prod_ID[0] + "_PBS",  # The path to the submission node (NB: must NOT be under /home : PBS cannot read/write into it!!)
