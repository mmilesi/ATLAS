...
event_branches       = ["EventNumber","RunNumber","mc_channel_number","passEventCleaning","onelep_type","dilep_type","trilep_type","total_charge","total_leptons","nJets_OR_T","nJets_OR","nJets_OR_T_MV2c20_70","nJets_OR_MV2c20_70","nJets_OR_T_MV2c20_77","nJets_OR_MV2c20_77","nTaus_OR_Pt25","Mll01","Ptll01","DRll01","Mlll012","Mll02","Ptll02","DRll02","Mll12","Ptll12","DRll12","HT","HT_lep","HT_jets","MET_RefFinal_et","MET_RefFinal_phi","isBlinded"]
...
lep_branches         = ["lep_ID_0","lep_Index_0","lep_Pt_0","lep_E_0","lep_Eta_0","lep_Phi_0","lep_EtaBE2_0","lep_sigd0PV_0","lep_Z0SinTheta_0",
                        ...
                        "lep_isTrigMatch_0","lep_isPrompt_0","lep_isBremsElec_0","lep_isFakeLep_0","lep_truthType_0","lep_truthOrigin_0",
                        ...
                        "lep_isTrigMatch_1","lep_isPrompt_1","lep_isBremsElec_1","lep_isFakeLep_1","lep_truthType_1","lep_truthOrigin_1",
                        ...
                        "lep_isTrigMatch_2","lep_isPrompt_2","lep_isBremsElec_2","lep_isFakeLep_2","lep_truthType_2","lep_truthOrigin_2",
...
print("Will be activating branches from input TTree:")
