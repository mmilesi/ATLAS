...
PRW_files = ["tthML.PURWTconfig.341177.root","tthML.PURWTconfig.341270.root","tthML.PURWTconfig.341271.root","tthML.PURWTconfig.341997.root","tthML.PURWTconfig.341998.root","tthML.PURWTconfig.341999.root","tthML.PURWTconfig.342000.root","tthML.PURWTconfig.342001.root","tthML.PURWTconfig.342002.root","tthML.PURWTconfig.342003.root","tthML.PURWTconfig.342004.root","tthML.PURWTconfig.342005.root","tthML.PURWTconfig.342170.root","tthML.PURWTconfig.342171.root","tthML.PURWTconfig.342172.root","tthML.PURWTconfig.361073.root","tthML.PURWTconfig.361079.root","tthML.PURWTconfig.361085.root","tthML.PURWTconfig.361087.root","tthML.PURWTconfig.410009.mc15b.root","tthML.PURWTconfig.410080.root","tthML.PURWTconfig.410081.root"]
...
MuonSelectorDict = { "m_name"                      : "muonSelect_LooseSelection",
		     "m_debug"		           :  False,
                     "m_inContainerName"	   : "Muons_Calib",
                     "m_outContainerName"	   : "Muons_LooseSelected",
...
MuonSelectorTightDict = { "m_name"                     : "muonSelect_TightSelection",
                          "m_debug"		       :  False,
                          "m_inContainerName"	       : "Muons_Calib",
                          "m_outContainerName"	       : "Muons_TightSelected",
                          "m_inputAlgoSystNames"       : "MuonCalibrator_Syst",
                          "m_outputAlgoSystNames"      : "MuonSelector_TightSyst",
                          "m_createSelectedContainer"  : True,
                          "m_decorateSelectedObjects"  : True,
                          "m_pass_min"		       : 0,
                          "m_pT_min"                   : 10e3,
...
ElectronSelectorDict = { "m_name"                      : "electronSelect_LooseSelection",
		         "m_debug"		       :  False,
                         "m_inContainerName"	       : "Electrons_Calib",
                         "m_outContainerName"	       : "Electrons_LooseSelected",
...
ElectronSelectorTightDict = { "m_name"                      : "electronSelect_TightSelection",
                              "m_debug"		            :  False,
                              "m_inContainerName"	    : "Electrons_Calib",
                              "m_outContainerName"	    : "Electrons_TightSelected",
                              "m_inputAlgoSystNames"        : "ElectronCalibrator_Syst",
                              "m_outputAlgoSystNames"       : "ElectronSelector_TightSyst",
                              "m_createSelectedContainer"   : True,
                              "m_decorateSelectedObjects"   : True,
                              "m_pass_min"	            : 0,
                              "m_pT_min"	            : 10e3,
                              ...
                              "m_confDirPID"	            : "mc15_20160113",
                              "m_doLHPIDcut"                : True,
                              "m_LHOperatingPoint"	    : "Tight", # for loose ID, use "LooseAndBLayer" if NOT reading ID flags from DAOD
                              "m_doCutBasedPIDcut"          : False,
                              "m_CutBasedOperatingPoint"    : "IsEMLoose",
                              "m_CutBasedConfigYear"	    : "",
                              "m_MinIsoWPCut"	            : "FixedCutTight",
                              "m_IsoWPList"  	            : "Loose,GradientLoose,Gradient,FixedCutLoose,FixedCutTight,FixedCutTightTrackOnly,UserDefinedCut",
                              "m_CaloIsoEff"  	            : "0.05*x",
                              "m_TrackIsoEff"  	            : "0.05*x",
                              "m_CaloBasedIsoType"  	    : "topoetcone20",
...
METConstructorDict = { "m_name"                  : "met",
		       "m_debug"		 : False,
                       ...
                       "m_inputElectrons"	 : "Electrons_LooseSelected",
                       "m_inputPhotons" 	 : "Photons",
                       "m_inputTaus"		 : "Taus_Selected",
                       "m_inputMuons"		 : "Muons_LooseSelected",
...
OverlapRemoverDict = { "m_name"                       : "overlap_removal_HTop",
		       ...
		       "m_decorateSelectedObjects"    : True,
         	       "m_useSelected"  	      : True,
         	       "m_inContainerName_Muons"      : "Muons_TightSelected",
         	       "m_outContainerName_Muons"     : "Muons_OR",
         	       "m_inputAlgoMuons"	      : "",
         	       "m_inContainerName_Electrons"  : "Electrons_TightSelected",
...
MuonEfficiencyCorrectorDict = { "m_name"                  : "muonEfficiencyCorrector",
                                "m_debug"	          : False,
                                "m_inContainerName"       : "Muons_LooseSelected",
...
ElectronEfficiencyCorrectorDict = { "m_name"                  : "electronEfficiencyCorrectorTight",
                                    "m_debug"		      : False,
                                    "m_inContainerName"	      : "Electrons_LooseSelected",
                                    ...
                                    #"m_corrFileNameIso"       : "$ROOTCOREBIN/data/ElectronEfficiencyCorrection/efficiencySF.Isolation.LooseAndBLayerLLH_d0z0_v8_isolLoose.2015.13TeV.rel20p0.25ns.v04.root", # comment if d0z0 cuts are NOT tight (TTVA)
...
HTopMultilepEventSelectorDict = { "m_name"                   : "eventSelect_skim",
		                  "m_debug"	             : False,
		                  "m_useCutFlow"             : True,
                		  "m_inContainerName_el"     : "Electrons_LooseSelected",
                		  "m_inContainerName_mu"     : "Muons_LooseSelected",
                		  "m_inContainerName_jets"   : "AntiKt4EMTopoJets_OR",
                		  "m_outContainerName_lep"   : "Leptons_LooseSelected",
		                  "m_doMinObjCut"            : True,
		                  "m_doMaxObjCut"            : False,
   				  "m_n_leptons_min"          : 0,
...
TruthMatchAlgoDict = { "m_name"                           : "truthMatching",
		       "m_debug"		          : False,
                       "m_inContainerName_Electrons"	  : "Electrons_LooseSelected",
                       "m_inContainerName_Muons"	  : "Muons_LooseSelected",
                       "m_inContainerName_Leptons"        : "Leptons_LooseSelected",
...
HTopMultilepTreeAlgoDict = { "m_name"                  : "physics",
		             "m_debug"  	       : False,
                   	     "m_muContainerName"       : "Muons_LooseSelected",
                   	     "m_elContainerName"       : "Electrons_LooseSelected",
                   	     "m_jetContainerName"      : "AntiKt4EMTopoJets_OR",
                   	     "m_tauContainerName"      : "Taus_OR",
                   	     "m_lepContainerName"      : "Leptons_LooseSelected" ,
